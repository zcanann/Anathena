namespace Squalr.Engine.Processes
{
    ...
    public class NormalizedProcess
    {
        ...
        public NormalizedProcess(Process process)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizedProcess" /> class. This is a constructor for a dummy process.
        /// </summary>
        /// <param name="processName">The name of the dummy process.</param>
        public NormalizedProcess(String processName)
        {
            this.Process = null;
